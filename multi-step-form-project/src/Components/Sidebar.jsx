...
const Sidebar = ({ steps, currentStep }) => (
    <div className="flex md:flex-col gap-6 pt-10 md:p-6 items-start justify-center bg-[url('./assets/images/bg-sidebar-mobile.svg')] md:bg-[url('./assets/images/bg-sidebar-desktop.svg')] bg-no-repeat bg-center md:h-auto h-[150px] bg-cover md:rounded-md md:w-1/5">
      {steps.map((item) => (
